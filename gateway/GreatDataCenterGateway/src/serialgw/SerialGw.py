...
class SerialGw(object):
    ...
    def readSerial(self):
        ...
        jsonsensors = {'id': 1, 'voltage_companhia': 70, 'date': datetime.datetime.utcnow()}
        #jsonsensors = {'id': 2, 'temperature': 26.0, 'humidity': 31.0, 'date': datetime.datetime.utcnow()}
        #jsonsensors = {'id': 3, 'temperature': 26.0, 'humidity': 31.0, 'voltage_gerador': 70, 'date': datetime.datetime.utcnow()}
        print jsonsensors  
        return jsonsensors